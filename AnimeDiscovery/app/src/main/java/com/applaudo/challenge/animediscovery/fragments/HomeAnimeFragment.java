...
public class HomeAnimeFragment extends Fragment implements SearchView.OnQueryTextListener{

    //Variable declaration
    private static final String ARG_GENRE = "genre";
    private GenresResponse mGenreResponse;
    private GenresBaseAdapter mGenresBaseAdapter;
    private final boolean IS_ANIME = true;
    private SearchView mSearchMediaSearchView;
    private ListView mGenreListView;


    public HomeAnimeFragment() {
        // Required empty public constructor
    }

    //Creating instance
    public static HomeAnimeFragment newInstance(GenresResponse genreResponse) {
        HomeAnimeFragment fragment = new HomeAnimeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View myInflatedView = inflater.inflate(R.layout.fragment_home_anime, container,false);
